...
class _ExtendedGraphConvKerasModel_ExtraDesc(tf.keras.Model):
  def __init__(self,
               n_tasks,
               graph_conv_layers,
               dense_layer_size,
  ...
  def call(self, inputs, training=False):
    ...
    # Add in molecule level features here:
    dl_in = tf.concat(axis=1, values=(neural_fingerprint, mol_features))
